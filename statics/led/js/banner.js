...
$(function() {
  ...
  function showPics(index) { //普通切换
	...
	//为当前的按钮切换到选中的效果
	$("#focus .btn span").stop(true,false).css({"background":"url(images/banner_b.png) no-repeat"})
	　.eq(index).stop(true,false).css({"background":"url(images/banner_w.png) no-repeat"}); 
  }
});