        ...
        all_box.children(".button_box").children("img").hover(
            function(){
                ...
                if(tip_position == 'left'){
                    all_box.children(".show").css({ top: (parseInt(-position_data[index].y*2)+20)+"px", left: (parseInt(position_data[index].x)-e)+"px" });
                }else{
                    //all_box.children(".show").css({ top: (parseInt(-position_data[index].y*2)+20)+"px", left: (parseInt(position_data[index].x)+30)+"px" });
					all_box.children(".show").css({ top: "46%", left: "50%", 'margin-top': "-580px",'margin-left':"-353px" });
                }
