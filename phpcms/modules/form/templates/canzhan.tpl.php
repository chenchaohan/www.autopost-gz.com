...
//-->
			...
			<br/>
            <h2 style="text-align:center"><?php echo L('canzhan'); ?></h2>
				...
				<div class="table-list">
					<table width="100%" cellspacing="0">
						<thead>
							<tr>
								...
								<th align="left"><?php echo L('weburl'); ?></th>
								<th align="left"><?php echo L('standard'); ?></th>
								<th align="left"><?php echo L('raw'); ?></th>
								...
								<th align="left"><?php echo L('uploadimg'); ?></th>
					...
					?>
						<tr>
							...
							<td align="left"><?php echo $form['weburl']; ?></td>
							<td align="left"><?php echo $form['standard']; ?></td>
							<td align="left"><?php echo $form['raw']; ?></td>
							...
							<td align="left"><?php if($form['uploadimg']){?><img src="<?php echo $form['uploadimg']; ?>" style="width:160px; height:200px;"><?php }?></td>
					...
					<div class="btn">
						...
						<input name="submit" type="submit" class="button" value="<?php echo L('remove_all_selected'); ?>" onClick="document.myform.action='?m=form&c=admin_form&a=delete_canzhan';return confirm('<?php echo L('affirm_delete'); ?>');">
