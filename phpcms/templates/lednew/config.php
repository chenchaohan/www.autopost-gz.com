<?php return array (
  ...
  array (
    ...
    'templates|lednew|link' => 
    array (
      'index.html' => '',
      'list_type.html' => '分类页',
      'register.html' => '申请页',
    ),
    'templates|lednew|special' => 
    array (
      'api_picture.html' => '组图',
    ...
    'templates|lednew|announce' => 
    array (
      'show.html' => '内容页',
    ),
    'templates|lednew|wap' => 
    array (
    ...
    'templates|lednew|phpsso' => 
    array (
      'index.html' => '首页',
    ),
    'templates|lednew|search' => 
    array (
      'footer.html' => '页尾',
      'header.html' => '页头',
      'index.html' => '首页',
    ...
    'templates|lednew|formguide' => 
    array (
      'index.html' => '表单列表页模板',
      'show.html' => '表单详情页模板',
      'show_js.html' => '表单js调用模板',
    ),
    'templates|lednew|mood' => 
    array (
      'index.html' => '新闻心情',
    ),
    'templates|lednew|yp' => 
    ...
    'templates|lednew|yp|com_LED' => 
    array (
      'index.html' => '公司首页模板',
      'style' => '样式文件夹',
    ),
    'templates|lednew|comment' => 
    array (
