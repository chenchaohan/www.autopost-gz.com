...
//-->
            ...
            <h2 style="text-align:center"><?php echo L('caigoum'); ?></h2>
				...
				<div class="table-list">
					<table width="100%" cellspacing="0">
						<thead>
							<tr>
								...
								<th align="left"><?php echo L('content'); ?></th>
								<th align="left"><?php echo L('time'); ?></th>
					...
					?>
						<tr>
							...
							<td align="left"><?php echo $form['content']; ?></td>
							<td align="left"><?php echo $form['time']; ?></td>
					...
					<div class="btn">
						...
						<input name="submit" type="submit" class="button" value="<?php echo L('remove_all_selected'); ?>" onClick="document.myform.action='?m=form&c=admin_form&a=delete_caigoum';return confirm('<?php echo L('affirm_delete'); ?>');">
