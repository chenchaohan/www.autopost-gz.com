...
<div class="col-2 col-auto">
	...
	<div class="content">
	<?php echo L('main_version')?>随行 <?php echo PC_VERSION?>  Release <?php echo PC_RELEASE?> [<a href="http://www.intexh.com/" target="_blank"><?php echo L('main_latest_version')?></a>]<br />
...
<div class="col-2 lf mr10" style="width:48%">
	...
	<div class="content">
	<?php echo L('main_copyright')?>：广州随行信息科技有限公司<br />
	<?php echo L('main_product_site')?><a href="http://www.intexh.com/" target="_blank">http://www.intexh.com/</a> <br />
	<?php echo L('main_product_bbs')?><a href="http://www.intexh.com/" target="_blank">http://www.intexh.com/</a> 
	</div>
</div>
...
<!--<div class="col-2 col-auto">
	...
	<div class="content">
	<?php echo L('main_version')?>随行 <?php echo PC_VERSION?>  Release <?php echo PC_RELEASE?> [<a href="http://buy.phpcms.cn" target="_blank"><?php echo L('main_support')?></a>]<br />
