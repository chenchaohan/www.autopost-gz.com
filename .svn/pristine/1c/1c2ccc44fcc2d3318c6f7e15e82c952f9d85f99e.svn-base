...
//-->
				...
				<p><span style="padding-right:6px;">请选择表单:</span>
                	<a style="color:#004499; padding-right:6px;" href="index.php?m=form&c=admin_form&a=caigou"><?php echo L('caigou'); ?></a>
				...
				<div class="table-list">
					<table width="100%" cellspacing="0">
						<thead>
							<tr>
								...
								<th align="left"><?php echo L('industry'); ?></th>
								<th align="left"><?php echo L('agency'); ?></th>
								<th align="left"><?php echo L('show_ad'); ?></th>
								<th align="left"><?php echo L('show_led'); ?></th>
								<th align="left"><?php echo L('调查'); ?></th>
								<th align="left"><?php echo L('item'); ?></th>
					...
					?>
						<tr>
							...
							<td align="left"><?php echo $form['industry']; ?></td>
							<td align="left"><?php echo $form['agency']; ?></td>
							<td align="left"><?php echo $form['show_ad']; ?></td>
							<td align="left"><?php echo $form['show_led']; ?></td>
							<td align="left"><?php echo $form['diaocha']; ?></td>
							<td align="left"><?php echo $form['item']; ?></td>
